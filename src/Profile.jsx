...
function Profile() {
    ...
    <div className='m-5'>
        {profile ? (
            <div >
                <img className='rounded-circle profile' src={profile.profile_pic} alt="profile"/>
                <h5>{profile.username}</h5>
                <input type="text" value = {profile.username} name="username" className='form-control my-4'
                onChange={HandleOnChange} />

             <input type="text" value = {profile.profile_pic} name="profile_pic" className='form-control'
             onChange={HandleOnChange}/>
